...
from shapes_experiment.misc import (EXP_DIR, IMAGES_DIR, IMAGES_SUB_DIRS,
                                    IMAGES_SUB_SUB_DIRS)
...
def run_on_images_and_save_as_dfs(images, stim_dir):
    ...
    for l in range(layers):
        ...
        # print(layer_df.head())
        try:
            os.makedirs(EXP_DIR + 'layer_representations/' + stim_dir)
        except OSError:
            pass
        layer_df.to_csv(EXP_DIR + 'layer_representations/' + stim_dir +
